...
/**
 * The smg_gameScreen class
 * This is the activity that the user will interact with
 * as part of the Simon game I have built.
 * <h5>Global variables</h5>
 * <p>All of the necessary variable to initialize and use our smg_gameScreen</p>
 * @author  Alejandro Rivera
 * @version 1.0
 * @since   2019-11-24
 */
public class smg_gameScreen extends AppCompatActivity {

    private static final String TAG = "smg_gameScreen";
    private smg_CustomView simonControl;
...
//    private TextView currLevel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.smg_game_screen);
...
//        mode2 = (Button) findViewById(R.id.btn_2_player);
        simonControl = (smg_CustomView) findViewById(R.id.simon_panel);
        //starting app sound
