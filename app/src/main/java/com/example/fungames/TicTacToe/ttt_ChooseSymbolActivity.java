...
public class ttt_ChooseSymbolActivity extends AppCompatActivity implements View.OnTouchListener {
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN); //enable full screen
        setContentView(R.layout.ttt_activity_choose_symbol);
        ...
        ContinueBtn.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 ...
                 Intent intent = new Intent(    ttt_ChooseSymbolActivity.this, ttt_OfflineGameActivity.class);
