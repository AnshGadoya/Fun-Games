...
public class ttt_SettingsActivity extends AppCompatActivity {
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN); //enable full screen
        setContentView(R.layout.ttt_activity_settings);
         ...
         else if(!ttt_MyServices.VIBRATION_CHECK)
         {
         ...
         vibrationSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
               if(isChecked)
               {
                   ttt_MyServices.VIBRATION_CHECK =true;
               }
               else {
                   ttt_MyServices.VIBRATION_CHECK= false;
               }
            }
        ...
        else if(!ttt_MyServices.SOUND_CHECK)
        {
       ...
       soundSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked)
                {
                    ttt_MyServices.SOUND_CHECK =true;
                }
                else {
                    ttt_MyServices.SOUND_CHECK= false;
                }
            }
