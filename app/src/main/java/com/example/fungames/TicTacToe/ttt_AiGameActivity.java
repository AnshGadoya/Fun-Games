package com.example.fungames.TicTacToe;


import static com.example.fungames.TicTacToe.ttt_Minmax.findBestMove;
...
public class ttt_AiGameActivity extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ttt_activity_ai_game);
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent = new Intent(ttt_AiGameActivity.this, ttt_SettingsActivity.class);
    ...
    public void onClick(View view) {
        ...
        if(ActivePlayer ==  Player_X   &&  filledPos[gettingTag-1] == -1 && PICK_SIDE == Player_X )
        {
            ...
            if(ttt_MyServices.SOUND_CHECK) {
                final MediaPlayer mp = MediaPlayer.create(this, R.raw.x);
                mp.start();
            }


            if(ttt_MyServices.VIBRATION_CHECK) {
    ...
    private void AI()
    {
        ...
        ttt_Minmax.Move bestMove = findBestMove(board);
    ...
    private void celebrateDialog(int player_check) {
        ...
        dialog.setContentView(R.layout.ttt_celebrate_dialog);
        ...
        quitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                Intent intent = new Intent(ttt_AiGameActivity.this, ttt_OfflineGameMenuActivity.class);
    ...
    private void    DrawDialogfun() {
        ...
        drawdialog.setContentView(R.layout.ttt_draw_dialog);
    ...
    private void    robotDialogfun() {
        ...
        robotdialog.setContentView(R.layout.ttt_robot_win_dialog);
    ...
    private void    quitDialogfun() {
        ...
        quitdialog.setContentView(R.layout.ttt_quit_dialog);
