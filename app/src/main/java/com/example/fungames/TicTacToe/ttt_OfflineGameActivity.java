...
public class ttt_OfflineGameActivity extends AppCompatActivity implements View.OnClickListener  {
...
//               WindowManager.LayoutParams.FLAG_FULLSCREEN); //enable full screen
        ...
        setContentView(R.layout.ttt_activity_offline_game);
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent = new Intent(ttt_OfflineGameActivity.this, ttt_SettingsActivity.class);
    ...
    private void celebrateDialog(int player_check) {
        ...
        quitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                Intent intent = new Intent(ttt_OfflineGameActivity.this, ttt_OfflineGameMenuActivity.class);
