...
public class ttt_OfflineGetPlayersNamesActivity extends AppCompatActivity implements View.OnTouchListener {
...
//               WindowManager.LayoutParams.FLAG_FULLSCREEN); //enable full screen
        ...
        setContentView(R.layout.ttt_activity_offline_get_players_names);
        ...
        playerTwoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(playerTwoName.getText().toString())) {
                    ...
                    Intent intent = new Intent(ttt_OfflineGetPlayersNamesActivity.this, ttt_ChooseSymbolActivity.class);
