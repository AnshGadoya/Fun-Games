...
public class ttt_AIGetPlayerNameActivity extends AppCompatActivity implements View.OnTouchListener {
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN); //enable full screen
        ...
        setContentView(R.layout.ttt_activity_aiget_player_name);
        ...
        playerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(playerNameTxt.getText().toString())) {
                    ...
                    Intent intent = new Intent(ttt_AIGetPlayerNameActivity.this, ttt_AiChooseSymbolActivity.class);
