...
public class ttt_OfflineGameMenuActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ttt_activity_offline_game_menu);
        ...
        WithAFriendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ttt_OfflineGameMenuActivity.this, ttt_OfflineGetPlayersNamesActivity.class);
        ...
        WithAi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ttt_OfflineGameMenuActivity.this, ttt_AIGetPlayerNameActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
            }
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent = new Intent(ttt_OfflineGameMenuActivity.this, ttt_SettingsActivity.class);
                        startActivity(intent);
