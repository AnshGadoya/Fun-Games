...
import com.example.fungames.wordSearch.model.GameDataBase;
import com.example.fungames.wordSearch.model.WordList;
...
public class DashboardActivity extends Activity implements OnItemClickListener,
	...
	private class DashboardListAdapter extends ArrayAdapter<String> {
		...
		private final int ITEM_LAYOUT = R.layout.ws_dashboart_list_item;

		public DashboardListAdapter(Context context, List<String> values) {
			super(context, R.layout.ws_dashboart_list_item, values);
			mContext = context;
			mValues = values;
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ws_activity_dashboard);
	...
	public void onItemClick(AdapterView<?> parent, View view, int pos, long id) {
		...
		if (pos == NEW_GAME) {
			...
			savedGameIntent.putExtra(GameActivity.EXTRA_GAME_ID, mSavedGames.get(gameIndex));
